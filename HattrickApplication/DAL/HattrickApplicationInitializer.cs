...
namespace HattrickApplication.DAL
{
    public class HattrickApplicationInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<HattrickApplicationContext>
    {
        protected override void Seed(HattrickApplicationContext context)
        {
            ...
            {
            new TicketItem{TicketID=1, UserID=1, EventID=1, TipType=Tip.T1, TipOdd=1.15m},
            ...
            new TicketItem{TicketID=2, UserID=1, EventID=2, TipType=Tip.T1, TipOdd=1.15m},
            new TicketItem{TicketID=2, UserID=1, EventID=3, TipType=Tip.T2, TipOdd=2.3m},
            new TicketItem{TicketID=2, UserID=1, EventID=6, TipType=Tip.TX2, TipOdd=1.9m},
            new TicketItem{TicketID=3, UserID=1, EventID=2, TipType=Tip.T2, TipOdd=2.3m},
            new TicketItem{TicketID=4, UserID=1, EventID=4, TipType=Tip.T2, TipOdd=2.3m},
            new TicketItem{TicketID=5, UserID=1, EventID=2, TipType=Tip.T2, TipOdd=2.3m},
            new TicketItem{TicketID=5, UserID=1, EventID=3, TipType=Tip.T12, TipOdd=1.10m},
            new TicketItem{TicketID=6, UserID=1, EventID=2, TipType=Tip.TX, TipOdd=1.32m},
            new TicketItem{TicketID=6, UserID=1, EventID=4, TipType=Tip.T1, TipOdd=1.15m},
            new TicketItem{TicketID=6, UserID=1, EventID=6, TipType=Tip.T2, TipOdd=2.3m},
