...
namespace HattrickApplication.DAL
{
    public class HattrickApplicationInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<HattrickApplicationContext>
    {
        protected override void Seed(HattrickApplicationContext context)
        {
            ...
            {
            new Event{SportID=1, Home=context.Teams.FirstOrDefault(t => t.Name=="Hajduk"), Away=context.Teams.FirstOrDefault(t => t.Name=="Dinamo"), Start=DateTime.Parse("04.01.2019 17:00:00"), End=DateTime.Parse("04.01.2019 19:00:00"), Result="", T1=1.15m , T2=2.3m, TX=1.32m, T1X=1.10m, TX2=1.9m, T12=1.12m, IsTopEvent=true},
            new Event{SportID=1, Home=context.Teams.FirstOrDefault(t => t.Name=="Everton"), Away=context.Teams.FirstOrDefault(t => t.Name=="Arsenal"), Start=DateTime.Parse("2019-01-03 14:15:00"), End=DateTime.Parse("03.01.2019 16:15:00"), Result="", T1=1.15m , T2=2.3m, TX=1.08m, T1X=1.10m, TX2=1.9m, T12=1.12m, IsTopEvent=false},
            new Event{SportID=1, Home=context.Teams.FirstOrDefault(t => t.Name=="Hajduk"), Away=context.Teams.FirstOrDefault(t => t.Name=="Arsenal"), Start=DateTime.Parse("2019-01-03 19:30:00"), End=DateTime.Parse("03.01.2019 17:30:00"), Result="", T1=1.15m , T2=2.3m, TX=1.32m, T1X=1.10m, TX2=1.9m, T12=1.12m, IsTopEvent=false},
            new Event{SportID=1, Home=context.Teams.FirstOrDefault(t => t.Name=="Dinamo"), Away=context.Teams.FirstOrDefault(t => t.Name=="Everton"), Start=DateTime.Parse("2019-01-02 20:00:00"), End=DateTime.Parse("02.01.2019 22:00:00"), Result="", T1=1.15m , T2=2.3m, TX=1.32m, T1X=1.10m, TX2=1.9m, T12=1.12m, IsTopEvent=false},
            new Event{SportID=2, Home=context.Teams.FirstOrDefault(t => t.Name=="Cedevita"), Away=context.Teams.FirstOrDefault(t => t.Name=="Cibona"), Start=DateTime.Parse("2019-01-05 12:10:00"), End=DateTime.Parse("05.01.2019 14:10:00"), Result="", T1=1.15m , T2=2.3m, TX=1.32m, T1X=1.10m, TX2=1.9m, T12=1.12m, IsTopEvent=true},
            new Event{SportID=2, Home=context.Teams.FirstOrDefault(t => t.Name=="Cedevita"), Away=context.Teams.FirstOrDefault(t => t.Name=="Zadar"), Start=DateTime.Parse("2019-01-05 12:10:00"), End=DateTime.Parse("05.01.2019 14:10:00"), Result="", T1=1.15m , T2=2.3m, TX=1.32m, T1X=1.10m, TX2=1.9m, T12=1.12m, IsTopEvent=true},
            new Event{SportID=2, Home=context.Teams.FirstOrDefault(t => t.Name=="Zadar"), Away=context.Teams.FirstOrDefault(t => t.Name=="Cibona"), Start=DateTime.Parse("2019-01-05 12:10:00"), End=DateTime.Parse("05.01.2019 14:10:00"), Result="", T1=1.15m , T2=2.3m, TX=1.32m, T1X=1.10m, TX2=1.9m, T12=1.12m, IsTopEvent=true},
            new Event{SportID=3, Home=context.Teams.FirstOrDefault(t => t.Name=="Mladost"), Away=context.Teams.FirstOrDefault(t => t.Name=="Jadran"), Start=DateTime.Parse("2019-01-02 13:30:00"), End=DateTime.Parse("02.01.2019 15:30:00"), Result="", T1=1.15m , T2=2.3m, TX=1.09m, T1X=1.10m, TX2=1.9m, T12=1.12m, IsTopEvent=false},
            new Event{SportID=2, Home=context.Teams.FirstOrDefault(t => t.Name=="Cibona"), Away=context.Teams.FirstOrDefault(t => t.Name=="Cedevita"), Start=DateTime.Parse("2019-01-08 13:30:00"), End=DateTime.Parse("08.01.2019 15:30:00"), Result="", T1=1.15m , T2=2.3m, TX=1.32m, T1X=1.10m, TX2=1.9m, T12=1.12m, IsTopEvent=false},
            new Event{SportID=3, Home=context.Teams.FirstOrDefault(t => t.Name=="Jadran"), Away=context.Teams.FirstOrDefault(t => t.Name=="Mladost"), Start=DateTime.Parse("2019-01-07 13:30:00"), End=DateTime.Parse("07.01.2019 15:30:00"), Result="", T1=1.15m , T2=2.3m, TX=1.32m, T1X=1.10m, TX2=1.9m, T12=1.12m, IsTopEvent=false},
            new Event{SportID=1, Home=context.Teams.FirstOrDefault(t => t.Name=="Rijeka"), Away=context.Teams.FirstOrDefault(t => t.Name=="Zagreb"), Start=DateTime.Parse("2019-01-05 13:30:00"), End=DateTime.Parse("05.01.2019 15:30:00"), Result="", T1=1.05m , T2=2.3m, TX=1.32m, T1X=1.10m, TX2=1.9m, T12=1.12m, IsTopEvent=false},
            new Event{SportID=1, Home=context.Teams.FirstOrDefault(t => t.Name=="Zagreb"), Away=context.Teams.FirstOrDefault(t => t.Name=="Hajduk"), Start=DateTime.Parse("2019-01-09 13:30:00"), End=DateTime.Parse("09.01.2019 15:30:00"), Result="", T1=1.15m , T2=2.3m, TX=1.32m, T1X=1.10m, TX2=1.9m, T12=1.12m, IsTopEvent=false}
            };
